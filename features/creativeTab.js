...
glitchedItems.setItems([
	MixerItem.getItemStack(),
	NullBowItem.getItemStack(),
	NullHousingMenuItem.getItemStack(),
	NullCookieItem.getItemStack(),
	Stage1BowItem.getItemStack(),
	Stage2BowItem.getItemStack(),
	Stage3BowItem.getItemStack(),
	DragonHeadItem.getItemStack(),
    glitchedRod.getItemStack(),
    glitchedMap.getItemStack()
]);
...
housingItems.setItems([
    tpPadItem.getItemStack(),
    launchPadItem.getItemStack(),
    parkourPadItem.getItemStack(),
    actionPadItem.getItemStack(),
    hologramItem.getItemStack(),
    npcItem.getItemStack(),
    actionButtonItem.getItemStack(),
    statLeaderBoardItem.getItemStack(),
    parkourLeaderBoardItem.getItemStack(),
    trashCanItem.getItemStack(),
    biomeStickItem.getItemStack(),
    mailBoxItem.getItemStack(),
    eggHuntItem.getItemStack(),
    null,
    null,
    null,
    null,
    null,
    twitterItem.getItemStack(),
    youtubeItem.getItemStack(),
    instagramItem.getItemStack(),
    twitchItem.getItemStack(),
    discordItem.getItemStack(),
    null,
    null,
    null,
    null,
    ...
    null,
    null,
    dragonEggItem.getItemStack(),
    new Item("barrier").getItemStack(),
    chestbackgroundItem.getItemStack(),
    customCookie.getItemStack()
]);

register(("command"), () => {
	const nbt = Player.getHeldItem().getRawNBT();
	console.log(nbt);
	ChatLib.command("ct copy " + nbt);
}).setName("copynbtdata");